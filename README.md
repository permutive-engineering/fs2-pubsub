...
```sbt
libraryDependencies += "com.permutive" %% "fs2-pubsub" % "2.0.0"
```
...
```sbt
libraryDependencies += "com.permutive" %% "fs2-pubsub-pureconfig" % "2.0.0"
```
